...
plt.savefig('Plots/Area_WaveNet_NF_NSBH_3_det_train_NSBH_200k_train.png', dpi=400)
...
plt.savefig('Plots/CLvCR_test_WaveNet_NF_NSBH_3_det_200k_train.png', dpi=400)
