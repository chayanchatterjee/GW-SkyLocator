...
class ResNet:
    ...
    def residual_block(self, X, kernels_res, stride_res, kernel_size_res):
        ...
        out = tf.keras.layers.Conv1D(kernels_res, kernel_size=kernel_size_res, strides=stride_res, padding='same')(out)
    ...
    def construct_model(self):
        ...
        X = tf.keras.layers.Conv1D(self.kernels, kernel_size=self.kernel_size_res, strides=self.stride_res)(self.input1)
