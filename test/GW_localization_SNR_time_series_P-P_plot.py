...
f1 = h5py.File('Fixed_NSIDE/Injection_run_BNS_2_det_all_SNR_ResNet-34.hdf', 'r')
p = f1['Probabilities'][()]
ra_test = f1['RA_test'][()]
...
plt.savefig('Plots/Area_ResNet_NF_BNS_2_det_train_all_SNR.png', dpi=400)
...
plt.savefig('Plots/CLvCR_test_ResNet_NF_BNS_2_det_all_SNR.png', dpi=400)
