...
f1 = h5py.File('../evaluation/Adaptive_NSIDE/Injection_run_NSBH_3_det_adaptive_SNR-10to20.hdf', 'r')
p = f1['Probabilities'][()]
ra_test = f1['RA_test'][()]
...
plt.savefig('Plots/Area_ResNet_NF_NSBH_3_det_train_50_epochs_SNR-10to20.png', dpi=400)
...
plt.savefig('Plots/CLvCR_test_ResNet_NF_NSBH_3_det_50_epochs_SNR-10to20.png', dpi=400)
