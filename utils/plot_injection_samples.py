...
f1 = h5py.File('../../SNR_time_series_sample_files/Injection_run_SNR_time_series_NSBH_NF_3_det_new_model.hdf', 'r')
p = f1['Probabilities'][()]
ra_test = f1['RA_test'][()]
...
plt.savefig('Injection_run_probabilistic/Area_WaveNet_NF_NSBH_3_det_train_NSBH.png', dpi=400)
...
plt.savefig('Injection_run_probabilistic/CLvCR_test_WaveNet_NF_NSBH_3_det_train_NSBH.png', dpi=400)
